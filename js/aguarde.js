...
function init() {
  ...
  playersRef.orderByKey() .on("child_added", function(data) {
   ...
   /*---------------------------------------------------> */
      ...
      var msg_var = firebase.database() .ref('/experiment/'+aguarde.experimentoChave+'/participant/' + f + '/answer/parte/decisaodaparte2');
     ...
     /* var contador = firebase.database().ref('/experiment/'+aguarde.experimentoChave+'/contador/');
      ...
      if(geralres==3){
        ...
        console.log("PRIMEIRO");
         //window.location.href="parte-final-pc.html?k="+QueryString.k+"&e="+QueryString.e;
          }
          else
            {
