...
function init() {
  ...
  playersRef.orderByKey() .on("child_added", function(data) {
   ...
   /*---------------------------------------------------> */
      ...
      var msg_var = firebase.database() .ref('/experiment/'+aguarde.experimentoChave+'/participant/' + f + '/answer/parte');
      msg_var.orderByKey() .once("child_added").then(function(data) {
        var msg = data.val();
        console.log('AAAAAAAAAACARALHO:' + msg.decisaodaparte2);
    /* Y - Número do grupo */
    /* Z - Data Key dos Players */
    /* F - Grupo do Player */
   /*---------------------------------------------------> */
     ...
     /* var contador = firebase.database().ref('/experiment/'+aguarde.experimentoChave+'/contador/');
        ...
        var contagem = firebase.database().ref('/experiment/'+aguarde.experimentoChave+'/contador/'+y+'/'+QueryString.k+ '/' + y + '/geral/');
      ...
      if(hola2 == va){
        var contagemA = firebase.database().ref('/experiment/'+aguarde.experimentoChave+'/contador/'+y+'/'+QueryString.k+ '/' +y + '/um/' );
      ...
      if (hola2 == vb){
        var contagemB = firebase.database().ref('/experiment/'+aguarde.experimentoChave+'/contador/'+y+'/'+QueryString.k+'/'+ y + '/dois/');
      ...
      if (hola2  == vc){
        var contagemC = firebase.database().ref('/experiment/'+aguarde.experimentoChave+'/contador/'+y+'/'+QueryString.k+'/'+ y + '/tres/');
      ...
      if (hola2  == vd){
        var contagemD = firebase.database().ref('/experiment/'+aguarde.experimentoChave+'/contador/'+y+'/'+QueryString.k+'/'+ y + '/quatro/');
      ...
      if (hola2  == ve){
        var contagemE = firebase.database().ref('/experiment/'+aguarde.experimentoChave+'/contador/'+y+'/'+QueryString.k+'/'+ y + '/cinco/');
      ...
      if (hola2  == vf){
        var contagemF = firebase.database().ref('/experiment/'+aguarde.experimentoChave+'/contador/'+y+'/'+QueryString.k+'/'+ y + '/seis/');
      ...
      var geralresult= firebase.database() .ref("/experiment/" + aguarde.experimentoChave+'/contador/'+ y + '/' + QueryString.k);
      geralresult.orderByChild(n) .once("child_added", function(data) {
      console.log('Caminho : experiment / '+ aguarde.experimentoChave+'/contador/'+ y + '/' + QueryString.k +'/'+ n + '/' );
      ...
      if(geralres==3){
        ...
        var nzerei = firebase.database().ref('/experiment/'+aguarde.experimentoChave+'/participant/'+QueryString.k+'/answer/vaizerarpt2');
        nzerei.set(false);
        console.log("PRIMEIRO");
         window.location.href="parte-final-pc-lider.html?k="+QueryString.k+"&e="+QueryString.e;
          }
          else
            {
        var zerei = firebase.database().ref('/experiment/'+aguarde.experimentoChave+'/participant/'+QueryString.k+'/answer/vaizerarpt2');
        zerei.set(true);
      ...
      if(geralres>=1)
      {
          ...
          var var_msg = firebase.database().ref('/experiment/'+ aguarde.experimentoChave + '/contador/' + y+'/' + QueryString.k+ '/' + y).once('child_changed').then(function(snapshot) {
